const level2 = new Level(100, 8000,
        [
            new Chicken(2000),
            new Chicken(2400),
            new Chicken(2800),
        ...
        [
            new BackgroundObject('./img/Battleground3.png', -719),
    
            new BackgroundObject('./img/Battleground3.png', 0),  
            new BackgroundObject('./img/Battleground3.png', 719),    
            new BackgroundObject('./img/Battleground3.png', 2*719),
    
            new BackgroundObject('./img/Battleground3.png', 3*719),
    
            new BackgroundObject('./img/Battleground3.png', 4*719),
    
            new BackgroundObject('./img/Battleground3.png', 5*719),
    
            new BackgroundObject('./img/Battleground3.png', 6*719),
    
            new BackgroundObject('./img/Battleground3.png', 7*719),
    
            new BackgroundObject('./img/Battleground3.png', 8*719),
    
            new BackgroundObject('./img/Battleground3.png', 9*719),
    
            new BackgroundObject('./img/Battleground3.png', 10*719),
    
            new BackgroundObject('./img/Battleground3.png', 11*719),
    
            new BackgroundObject('./img/Battleground3.png', 12*719),
        ]
